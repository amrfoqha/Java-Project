...
<body class="bg-gradient-to-br from-orange-50 via-white to-emerald-50 min-h-screen flex items-center justify-center py-10">

<!-- Main card container -->
<div class="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl p-10 overflow-hidden">
    ...
    <div class="absolute -bottom-20 -right-20 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse"></div>

    <!-- Quote -->
    <p class="text-center text-xl text-emerald-600 italic mb-6 relative z-10">"Cooking is the art of turning fresh ingredients into joy."</p>

    <!-- Title -->
    <h1 class="text-4xl font-extrabold text-orange-500 mb-10 text-center relative z-10">Create New Recipe</h1>

    <form:form modelAttribute="recipe" action="saveRecipe" method="post" class="space-y-6 relative z-10">
        ...
        <div>
            ...
            <form:textarea path="ingredients" required="true" placeholder="Write all ingredients here..." rows="4"
                           cssClass="border border-emerald-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-opacity-50 resize-none hover:shadow-md transition"/>
        </div>
